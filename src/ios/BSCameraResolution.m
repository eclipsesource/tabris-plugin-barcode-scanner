...
+ (instancetype)withDictionary:(NSDictionary*)dictionary {
    ...
    width = [width isKindOfClass:[NSNumber class]] ? width : nil;

    NSNumber* height = [dictionary objectForKey:BSCameraResolutionHeightKey];
    height = [height isKindOfClass:[NSNumber class]] ? height : nil;
...
- (BOOL)isEqual:(id)object {
    BSCameraResolution* otherBSCameraResolution = [object isKindOfClass:[BSCameraResolution class]] ? object : nil;
